...
export default class Shipper extends React.Component {
  componentDidMount() {
    document.title = 'kalpartz - 5PL Logistics & Brokerage';
  }
        ...
        <div className="flex lg:flex-row   flex-col p-8">
          <div className="self-end lg:pl-32 lg:pr-32">
            ...
            <p className="font-normal pt-2 text-xl w-auto">
              Put our purchasing intelligence to work. kalpartz Logistics has
              negotiated pricing with over 120 of North America’s top LTL
              carriers. Enjoy extra savings with our extensive capacity and
              access to lower rates. Choose kalpartz Logistics for complete
              supply chain visibility. Save time as our experts do the
              transportation legwork, including carrier sourcing, step-by-step
              shipment tracking, and auditing and billing
            </p>
            <h3 className="font-bold pt-10 text-xl">
              Cost-Effective Truckload Solutions
            </h3>
            <p className="font-normal pt-2 text-xl w-auto">
              kalpartz Logistics moves thousands of loads a day via our network
              of over 50,000 truckload carriers. Regardless of season or spikes,
              we have capacity for your shipments. Save time as our
              full-truckload experts handle load tender, track and trace, data
              management, order processing, invoice auditing, and bill payment.
              kalpartz Logistics technology gives you complete visibility into
              each shipment, from step-by-step tracking to custom reporting.
            </p>
            {/* <h3 className="font-bold pt-10 text-xl">REAL-TIME TRACKING</h3>
            <p className="font-normal pt-2 text-xl">
              The kalpartz Logistics mobile app allows drivers to provide
              real-time tracking, reducing the need for check-in phone calls.{" "}
            </p>
            <h3 className="font-bold pt-10 text-xl">DOCUMENT UPLOAD</h3>
            <p className="font-normal pt-2 text-xl">
              TWith the kalpartz Logistics mobile app, drivers can quickly and
          ...
          <div className="flex-1 h-64">
            ...
            <p className="font-normal pt-10 text-xl 2xl:w-96 pb-8">
              ...
              With every solution, kalpartz Logistics simplifies transportation
        ...
        <div className="flex flex-row lg:pr-16 p-8">
          <div className="self-end lg:pl-32 lg:pr-16 pb-16">
            <h3 className="font-bold pt-4 text-xl">
              kalpartz Logistics has Combined 30 years’ experience moving
            ...
            <p className="font-normal pt-1 text-xl ">
              ...
              to 35,000 square feet. kalpartz has similar border services at all
