        ...
        <HeroContainer ontainer id="Carrers ">
          ...
          <HeroContent className="flex flex-col 	justify-items-end lg:w-1/2">
            ...
            <PCENTER class="text-white lg:p-8 text-left m-8">
              ...
              <p>
                Being part of the kalpartzs family means surrounding yourself
                with a sense of openness and inclusivity,a group of different
                people who’ve created an environment where everyone is willing
                to help everyone.
              </p>
            </PCENTER>
          </HeroContent>
            ...
            <Pulse>
              <Card className="flex flex-col items-left h-auto bg-white w-auto p-8 lg:h-96">
                ...
                <p className="font-light self-left pt-4 pb-20 lg:h-40">
                  At kalpartz, carriers may access preloaded trailers to turn
                  down the load time significantly. Due to this free carriers
                  avoid unplanned delays which shortens detention durations.
                </p>
              </Card>
            </Pulse>
            <Pulse>
              <Card className="flex flex-col items-left h-auto bg-white w-auto p-8 lg:h-96">
                ...
                <p className="font-light self-left pt-4 pb-20 lg:h-40">
                  Ease in searching next loads in queue. kalpartz has made
                  backhauling so easy .
                </p>
              </Card>
            </Pulse>
            <Pulse>
              <Card className="flex flex-col items-left h-auto bg-white w-auto p-8 lg:h-96">
                ...
                <p className="font-light self-left pt-4 pb-20 ">
                  Association with kalpartz can bring exciting business
            ...
            <div className=" flex lg:flex-row flex-col-reverse ">
              <div className="lg:pr-40 ml-4 mt-20 lg:w-4/5 mr-4">
                ...
                {/* <p className="text-gray-800 font-normal pt-8 text-xl w-auto ">
                  At kalpartz, our e-commerce solutions allow you to gain greater
