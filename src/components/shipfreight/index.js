          ...
          <div className="self-end lg:pl-40 lg:pr-32">
            ...
            <div className=" pt-10 grid gap-10 lg:grid-cols-2 grid-cols-1">
              ...
              <div className="flex flex-col items-start">
                ...
                <p className="text-gray-800 font-normal pt-5 text-xl w-auto">
                  At kalpartz, we consolidate an extremely fragmented market by
              ...
              <div className="flex flex-col items-start">
                ...
                <p className="font-normal pt-5 text-xl w-auto">
                  ...
                  kalpartz will help you identify modal conversion opportunities
                  to maximize savings.
                </p>
              </div>
              <div className="flex flex-col items-start">
              ...
              <div className="flex flex-col items-start">
                ...
                <p className="text-gray-800 font-normal pt-5 text-xl w-auto">
                  kalpartz is an authorized reseller of UPS air services, with
                  ...
                  visibility and expertise you get from kalpartz.
                </p>
              </div>
              <div className="flex flex-col items-start">
                ...
                <p className="text-gray-800 font-normal pt-5 text-xl w-auto">
                  Whether shipping northbound or southbound, kalpartz leverages
                  a dense North American carrier network to bring you capacity
          ...
          <div className="bg-white hover:shadow-2xl 2xl:m-2 m-2 flex-1 transition duration-700 ease-in-out delay-150">
            ...
            <div className="p-8">
              ...
              <p className="text-gray-800 text-1xl mb-0 h-42  ">
                ...
                through your rep or kalpartzGO. If you are quoting for a spot
                LTL load, a high-volume lane, or anything else, we can get you a
        ...
        <div className=" pt-10 pb-10 grid gap-10 lg:grid-cols-2 grid-cols-1 p-4">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-gray-800 font-normal pt-5 text-xl w-auto">
              ...
              and carrier agnostic capacity solutions. kalpartz Transportation
          ...
          <div className="flex flex-col items-start">
            ...
            <p className=" text-gray-800 font-normal pt-5 text-xl w-auto">
              ...
              primary, backup and spot capacity from kalpartz. Our dedicated
              team of transportation specialists tap into one of the largest
          ...
          <div className="flex flex-col items-start">
            ...
            <p className=" text-gray-800 font-normal pt-5 text-xl w-auto">
              kalpartz’s mission is to move business forward with expertise and
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-gray-800 font-normal pt-5 text-xl w-auto">
              At kalpartz, we know there isn’t a one-size-fits-all solution for
              ...
              settlement through kalpartzGO®. Or make real-time data exchange
