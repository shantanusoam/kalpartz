  ...
  return (
    <WWOCArd>
      <WWOCardContent>
              ...
              <div className="bg-white hover:shadow-2xl m-9 flex-1 transition duration-700 ease-in-out delay-150 transition duration-700 ease-in-out delay-150">
                ...
                <div className="p-8">
                  ...
                  <div className=" text-gray-800 text-1xl mb-5 lg:h-56">
                    ...
                    short-term market volatility. kalpartz private and dedicated
                    fleet services bring you the dependability of professional
                    drivers on set schedules, without the expense of ownership.
                    Do you have your own fleet? kalpartz can identify back-haul
        ...
        <WWOCCHeading>
          CARRIER PACKET - JOIN TEAM AT kalpartz <br></br>1-800-303-0076
        </WWOCCHeading>
        <WWOCCParagraph>
          ...
          kalpartz logistics specialist, we’re just a phone call away. Life on
          the road is tough; let us make it easier. Rely on our specialist to
          know the loads you want, find opportunities that fit your network and
          stand by you when things get tough. We’re here to help you grow with a
